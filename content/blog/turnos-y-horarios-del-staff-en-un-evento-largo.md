---
title: "Cómo organizar los turnos y horarios del staff en un evento largo"
description: "Cómo se arma la grilla de turnos de un evento de muchas horas o varios días: bloques, solapamiento en los relevos, convocatoria escrita y control de que nadie quede doblado."
metaTitle: "Turnos y Horarios del Staff en un Evento Largo | LABURO"
slug: "turnos-y-horarios-del-staff-en-un-evento-largo"
canonical: "https://laburo.somosder.ar/blog/turnos-y-horarios-del-staff-en-un-evento-largo"
kicker: "Guía"
date: 2026-07-30
readingTime: "8 min"
order: 9
lang: es
faqs:
  - q: "¿Cómo se organizan los turnos del staff en un evento de varios días?"
    a: "Partiendo el evento en bloques operativos en vez de pensarlo como una jornada: montaje, apertura y acreditación, operación, y cierre y desmontaje. Cada bloque tiene su propia dotación, su propio horario de convocatoria y muchas veces su propia gente. Después se arma la grilla por posición (no por persona) y recién al final se le pone nombre a cada casillero. Armar la grilla al revés, empezando por los nombres disponibles, es lo que deja agujeros en el pico."
  - q: "¿Cuánto tiene que durar un turno de staff en un evento?"
    a: "El número lo definís vos según el rol y la exigencia física, pero la regla que sí es general es que la duración del turno tiene que estar escrita antes de que la persona acepte, y tiene que incluir la convocatoria previa. Un turno de barra en el pico y un turno de guardarropa en la madrugada no rinden igual a la misma cantidad de horas: los roles críticos se cortan antes que los tranquilos."
  - q: "¿Cómo hago los relevos sin que quede un puesto vacío?"
    a: "Solapando. El relevo entra unos minutos antes de que salga el que está, para que haya traspaso y el punto nunca quede sin nadie. Si el relevo entra a la misma hora que sale el anterior, en la práctica el puesto queda descubierto durante el traspaso, justo cuando se acumula la cola. Y los relevos se cuentan como dotación: si no están en la cuenta, se los sacás al mismo equipo."
  - q: "¿Cómo evito confirmar a la misma persona en dos eventos que se pisan?"
    a: "Teniendo el calendario y las confirmaciones en un solo lugar, no en chats separados. En LABURO el buscador tiene un filtro para ocultar a quienes ya están asignados a un evento que se solapa, el calendario maestro muestra cada evento con la cantidad de confirmados, y el tablero muestra por evento cuántos puestos están cubiertos y cuántos faltan."
---
...
1. Escribí las **posiciones** que tienen que estar cubiertas y en qué franja. "Barra 1, de 21 a 03". "Puerta 2, de 19 a 21".
2. Cortá cada franja en **turnos** según lo que aguanta el rol.
3. Recién ahí ponele **nombre** a cada casillero.
