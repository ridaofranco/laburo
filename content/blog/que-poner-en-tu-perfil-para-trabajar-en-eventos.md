---
title: "Qué poner en tu perfil para que te elijan para trabajar en eventos"
description: "Cómo te busca un productor, qué campos de tu perfil son filtros de búsqueda y cómo escribir tu experiencia para que te convoquen. Con los errores que dejan un perfil invisible."
metaTitle: "Qué Poner en tu Perfil para Trabajar en Eventos | LABURO"
slug: "que-poner-en-tu-perfil-para-trabajar-en-eventos"
canonical: "https://laburo.somosder.ar/blog/que-poner-en-tu-perfil-para-trabajar-en-eventos"
kicker: "Guía"
date: 2026-07-29
readingTime: "8 min"
order: 6
lang: es
faqs:
  - q: "¿Qué tengo que poner en mi perfil para que me contraten en eventos?"
    a: "Lo que sirve para que te encuentren y lo que sirve para que te elijan. Para que te encuentren: los puestos a los que aplicás elegidos de la lista, tu provincia y tu ciudad, tu disponibilidad (fines de semana, viajar, movilidad propia) y con cuánta anticipación podés tomar un trabajo. Para que te elijan: tus años de experiencia, la cantidad de eventos que trabajaste y un detalle concreto de en qué eventos, en qué roles y con qué marcas trabajaste. Y el email y el teléfono bien escritos, porque la propuesta llega por mail."
  - q: "¿Cómo escribo mi experiencia si nunca trabajé en eventos?"
    a: "Sin inventar nada y siendo específico con lo que sí hiciste. El formulario te pregunta si tenés experiencia en eventos y podés responder que no: se puede estar en el pool sin experiencia previa. Si trabajaste en gastronomía, en atención al público, en logística o manejando, escribilo con detalle en el campo de experiencia: qué hacías, cuánto tiempo y en qué tipo de lugar. Y cargá bien la zona y la disponibilidad, que es lo que más se filtra. Un perfil sin experiencia bien cargado rinde más que uno con experiencia mal escrito."
  - q: "¿Sirve subir el CV al perfil?"
    a: "Sí, por dos motivos. Primero, porque acelera la carga: se lee el CV y se completa buena parte del formulario solo, y vos revisás y corregís. Segundo, porque el productor puede ver tu CV cuando abre tu perfil. Después de subirlo conviene revisar campo por campo lo que quedó cargado: lo que se autocompleta mal y no se corrige es lo que después te deja afuera de una búsqueda."
  - q: "¿Conviene marcar todos los puestos de la lista para que me llamen más?"
    a: "No. Marcar veinte oficios no te hace aparecer en más búsquedas útiles: te hace aparecer en búsquedas donde no encajás, y el resultado más probable es una propuesta para algo que no sabés hacer. Marcá lo que sabés hacer de verdad y, si querés abrirte, sumá los puestos donde estarías dispuesto a arrancar de cero y aclaralo en el detalle de experiencia."
---
...
1. **No cargar la ciudad.** Te saca de las búsquedas por zona, que son casi todas.
2. **Marcar veinte oficios.** No aparecés en más búsquedas útiles; aparecés en las que no te sirven.
3. **Dejar la experiencia en dos líneas genéricas.** Es el campo que más se lee y el que menos se completa.
