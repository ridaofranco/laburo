---
title: "Cuánta gente necesitás para tu evento y cómo se calcula"
description: "La cuenta real para dimensionar el staff de un evento: puntos de servicio, ritmo, turnos y margen. Sin ratios mágicos por cantidad de asistentes."
metaTitle: "Cuánta Gente Necesitás para tu Evento y Cómo se Calcula | LABURO"
slug: "cuanta-gente-necesito-para-mi-evento"
canonical: "https://laburo.somosder.ar/blog/cuanta-gente-necesito-para-mi-evento"
kicker: "Guía"
date: 2026-07-29
readingTime: "8 min"
order: 4
lang: es
faqs:
  - q: "¿Cuánto staff necesito para un evento de 500 personas?"
    a: "No hay un número que dependa solo de la cantidad de asistentes. La dotación sale de cuatro variables: cuántos puntos de servicio tenés que tener atendidos al mismo tiempo, a qué ritmo tiene que despachar cada punto, cuántos turnos cubre la duración del evento, y qué margen dejás por ausencias. Dos eventos de 500 personas pueden necesitar dotaciones muy distintas según si hay barra, si se acredita en puerta y cuánto dura el montaje."
  - q: "¿Cómo se calcula cuánta gente hace falta en la puerta de un evento?"
    a: "Con tres datos tuyos: cuántas personas tenés que hacer entrar, en cuántos minutos querés que entren, y a qué ritmo valida un puesto de acreditación. Dividís la gente por los minutos para saber cuántas personas por minuto tenés que procesar, y ese número lo dividís por el ritmo de un puesto. El resultado son los puestos simultáneos que necesitás. El ritmo por puesto lo tenés que medir en tus propios eventos: cambia muchísimo según se escanee un QR o se busque un nombre en una lista."
  - q: "¿Por qué no sirve calcular el staff por cantidad de asistentes?"
    a: "Porque la cantidad de asistentes no te dice cuántos lugares físicos hay que atender ni cuántas horas dura la operación. El staff no atiende a una multitud en abstracto: atiende puntos concretos (una puerta, una barra, una caja) durante una franja horaria concreta. Un evento de mil personas de tres horas y uno de mil personas de doce horas con montaje propio no se parecen en nada en dotación."
  - q: "¿Cuánto margen hay que dejar por ausencias al armar el staff?"
    a: "El margen lo definís vos según qué tan crítico es el rol, pero la regla es que los roles críticos (puerta, caja, barra) no pueden quedar con dotación justa. Lo que ayuda es tener la dotación requerida escrita por rol y con cantidad, y poder ver cuántos de esos lugares están efectivamente confirmados. En LABURO se declara la dotación por rol y el tablero muestra cuántos están cubiertos y cuántos faltan, para que la cuenta sea un dato y no una sensación."
---
...
1. **Puntos de servicio.** Cuántos lugares físicos tienen que estar atendidos al mismo tiempo.
2. **Ritmo.** Cuánto despacha cada punto por unidad de tiempo.
3. **Turnos.** Cuántas veces hay que renovar a esa gente para cubrir toda la duración.
4. **Margen.** Cuánta gente de más ponés para que una ausencia no te deje un punto vacío.
