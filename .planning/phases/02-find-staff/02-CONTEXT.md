...
- **D-02:** **Nombre de la app: LABURO** — ✅ CONFIRMADO por Franco (2026-07-14: "ok, dejemos laburo, está bueno"). Propuesto por Claude a pedido suyo; argentinismo universal para "trabajo" (el mercado v1 es 100% Argentina — se asumió conscientemente que es jerga rioplatense y no viaja a todos los países; rebrand/localización es problema de v2+ si el marketplace se expande). Las letras redondas L-A-B-U-R-O rinden perfecto en tipografía bubble con glow azul. NO usar sufijo "by DER" en la marca visible salvo pedido de Franco.
