...
- **Buildable now (no external dep):** STAT-02 board, XTRA-01 favorites/notes, XTRA-03 re-filter, XTRA-04 rating, and the XTRA-02 cron+logic (code, not live-sending). Plus the live migrations (orchestrator applies).
