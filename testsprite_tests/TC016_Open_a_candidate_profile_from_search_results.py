...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Buscar' link in the sidebar to open the search area.
        # Buscar link
        ...
        # -> Open the candidate 'Abel Aníbal Izaguirre' from the search results.
        ...
        # --> Verify the candidate profile is displayed
        # Assert: The browser is on the candidate's staff page (URL contains the staff ID).
        await expect(page).to_have_url(re.compile("/staff/203dbf51\\-3191\\-4df8\\-b111\\-6bdd47245f98"), timeout=15000), "The browser is on the candidate's staff page (URL contains the staff ID)."
